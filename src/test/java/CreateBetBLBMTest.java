...
public class CreateBetBLBMTest {
    ...
    public void test1() {
        ...
        try {
            Mockito.doReturn(new Bet(mockedUser, betMoney, mockedForecast)).when(dataAccess).createBet(Mockito.any(String.class), Mockito.any(Float.class), Mockito.any(Integer.class));
        ...
        try {
            Mockito.verify(dataAccess,Mockito.atLeast(1)).createBet(dniCaptor.capture(),betMoneyCaptor.capture(), forecastNumberCaptor.capture());
    ...
    public void test5(){
        ...
        Mockito.doReturn(dni).when(mockedUser).getDni();
        try {
            Mockito.doThrow(new UserDoesntExist()).when(dataAccess).createBet(Mockito.any(String.class), Mockito.any(Float.class), Mockito.any(Integer.class));
        } catch (BetAlreadyExist | UserDoesntExist | ForecastDoesntExist e) {
            throw new RuntimeException(e);
        }
    ...
    public void test6(){
        ...
        try {
            Mockito.doThrow(new Error()).when(dataAccess).createBet(Mockito.any(String.class), Mockito.any(Float.class), Mockito.any(Integer.class));
        } catch (BetAlreadyExist | UserDoesntExist | ForecastDoesntExist e) {
            throw new RuntimeException(e);
        }
        try {
    ...
    public void test7(){
        ...
        Mockito.doReturn(dni).when(mockedUser).getDni();
        try {
            Mockito.doThrow(new ForecastDoesntExist()).when(dataAccess).createBet(Mockito.any(String.class), Mockito.any(Float.class), Mockito.any(Integer.class));
        } catch (BetAlreadyExist | UserDoesntExist | ForecastDoesntExist e) {
            throw new RuntimeException(e);
        }
